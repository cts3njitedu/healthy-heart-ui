...
export const API_ACTION_WORKOUT_DELETE_BUILD = "API_ACTION_WORKOUT_DELETE_BUILD"
...
export const ACTION_WORKOUT_DELETE = "ACTION_WORKOUT_DELETE"
export const ACTION_WORKOUT_DELETE_CONFIRMATION_YES = "ACTION_WORKOUT_DELETE_CONFIRMATION_YES"
export const ACTION_WORKOUT_DELETE_CONFIRMATION_NO = "ACTION_WORKOUT_DELETE_CONFIRMATION_NO"
export const ACTION_WORKOUT_DELETED = "ACTION_WORKOUT_DELETED"
...
export const deleteWorkout = (data) => ({
    type: ACTION_WORKOUT_DELETE,
    payload: {data}
})

export const deleteWorkoutFinish = (data) => ({
    type: ACTION_WORKOUT_DELETED,
    payload: {data}
})
